...
#         """
#
#         model = PReLIM(cpgDensity=self.cpg_density)
#         model = load(os.path.join(self.path_to_models, "saved_model_{}_cpgs.prelim".format(self.cpg_density)))
#         return model
#
