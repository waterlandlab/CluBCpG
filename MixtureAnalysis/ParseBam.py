...
class BamFileReadParser():
    ...
    def __init__(self, bamfile, quality_score, read1_5=None, read1_3=None,
        ...
        :param no_overlap: bool. If overlap exists between two reads, ignore that region from read 2. This is
    ...
    def create_matrix(self, read_cpgs):
        ...
        :return: pd.DataFrame of methylated (1) and unmethylated (0) states
        """
        series = []
